...
public class Rest_timer_40min extends AppCompatActivity {

    private static final long start_time = 2400000;
    ...
    private void starttimer(){
        mCountDownTimer = new CountDownTimer(mTimeleft,1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Rest_timer_40min.this, "Times up!", Toast.LENGTH_LONG).show();
            }
        }.start();
